import { ProfileAchievementsFacadeService } from './profile-achievements-facade.service'
import { IAchievement } from './profile-achievements.interface'
...
@Component({
  selector: 'app-main-profile-achievements',
...
export class ProfileAchievementsComponent implements OnInit {
  ...
  constructor(
    ...
    private facade: ProfileAchievementsFacadeService,
  ...
  goToNextForm() {
    this.router.navigate(['../learning-preferences'], { relativeTo: this.activatedRoute })
  }
}
