...
@Component({
  selector: 'app-programs-courses',
  templateUrl: './programs-courses.component.html',
  styleUrls: ['./programs-courses.component.scss'],
})
export class ProgramsCoursesComponent implements OnInit {
  constructor() {}

  enrolledData: CardInterface[] = [
    {
      caption: 'Hello world',
      content:
    ...
    {
      caption: 'Im fine!',
      content: 'Lorem Ipsum the leap into electronic typesetting, remaining essentially unchanged.',
