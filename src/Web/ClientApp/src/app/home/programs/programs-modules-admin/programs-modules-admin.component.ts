...
@Component({
  selector: 'app-programs-modules-admin',
  templateUrl: './programs-modules-admin.component.html',
  styleUrls: ['./programs-modules-admin.component.scss'],
  providers: [MessageService],
})
export class ProgramsModulesAdminComponent implements OnInit {
  id: string
  date: Date
  topic: string
  order: number
