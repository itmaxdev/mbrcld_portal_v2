...
{
    public sealed class ListInstructorProjectsViewModel
    {
        ...
        private sealed class MappingProfile : Profile
        {
            ...
            {
                CreateMap<Project, ListInstructorProjectsViewModel>()
                    ...
                    .ForMember(dst => dst.ApplicantName, x => x.MapFrom(src => src.ApplicantName))
