...
{
    public class RemoveUserFromRoomCommand : IRequest<Result>
    {
        public Guid UserId { get; set; }
        public Guid RoomId { get; set; }

        #region Command handler
        private sealed class CommandHandler : IRequestHandler<RemoveUserFromRoomCommand, Result>
        {
            ...
            public async Task<Result> Handle(RemoveUserFromRoomCommand request, CancellationToken cancellationToken)
            {
                await chatRepository.RemoveParticipant(request.UserId, request.RoomId, cancellationToken);
        ...
        public class CommandValidator : AbstractValidator<RemoveUserFromRoomCommand>
        {
