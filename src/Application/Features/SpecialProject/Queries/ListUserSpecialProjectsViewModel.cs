...
{
    public sealed class ListUserSpecialProjectsViewModel
    {
        ...
        private sealed class MappingProfile : Profile
        {
            ...
            {
                CreateMap<SpecialProject, ListUserSpecialProjectsViewModel>()
                    ...
                    .ForMember(dst => dst.Alumni, x => x.MapFrom(src => src.AlumniId))
