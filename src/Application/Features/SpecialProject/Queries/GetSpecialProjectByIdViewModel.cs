...
{
    public sealed class GetSpecialProjectByIdViewModel
    {
        ...
        private sealed class MappingProfile : Profile
        {
            ...
            {
                CreateMap<SpecialProject, GetSpecialProjectByIdViewModel>()
                    ...
                    .ForMember(dst => dst.SectorId, x => x.MapFrom(src => src.SectorId))
