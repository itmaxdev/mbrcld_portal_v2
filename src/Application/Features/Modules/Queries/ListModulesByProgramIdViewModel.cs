...
{
    public sealed class ListModulesByProgramIdViewModel
    {
        ...
        private sealed class MappingProfile : Profile
        {
            ...
            {
                CreateMap<Module, ListModulesByProgramIdViewModel>()
                    ...
                    .ForMember(dst => dst.CohortName, x => x.MapFrom(src => src.CohortName))
