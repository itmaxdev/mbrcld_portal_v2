        ...
        private sealed class MappingProfile : Profile
        {
            public MappingProfile()
            {
                CreateMap<ODataCohort, Cohort>()
                  ...
                  .ForMember(dst => dst.ProgramDescription, x => x.MapFrom(src => src.Program.Description))
                  .ForMember(dst => dst.ProgramDescription_AR, x => x.MapFrom(src => src.Program.Description_AR))
